...
CREATE INDEX QUAKES.Quakes_Event_DTG ON QUAKES.Quakes (Event_DTG);
...
-- CALL SYSCS_UTIL.SYSCS_IMPORT_TABLE ('QUAKES','QUAKES','E:\home\data\quake-info\NCEDC_earthquakes_reverse_geocoded_test_n_header.csv',null,null,null,0);
